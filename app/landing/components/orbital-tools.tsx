...
// const tools = [
//   { icon: "📋", label: "Tasks", orbitClass: "orbit-1", size: 140 },
//   { icon: "📊", label: "Analytics", orbitClass: "orbit-2", size: 200 },
//   { icon: "📅", label: "Calendar", orbitClass: "orbit-3", size: 280 },
//   { icon: "👥", label: "Team", orbitClass: "orbit-4", size: 350 },
//   { icon: "🎯", label: "Goals", orbitClass: "orbit-5", size: 420 },
//   { icon: "⚡", label: "Sprints", orbitClass: "orbit-6", size: 490 },
// ];

// export const OrbitalTools = () => {
//   return (
//     <div className="relative flex items-center justify-center w-175 h-175">
//       {/* Centre */}
//       <div className="absolute z-10 w-28 h-28 rounded-full flex items-center justify-center text-white font-bold shadow-lg">
//         <Image src={ColumnoC} height={200} width={200} alt="logo" />
//       </div>

//       {tools.map((tool) => (
//         <div
//           key={tool.label}
//           className={`absolute rounded-full border border-green-200/30 ${tool.orbitClass}`}
//           style={{ width: tool.size, height: tool.size }}
//         >
//           {/* Icône positionnée en haut du cercle */}
//           <div className="icon absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-lg cursor-pointer hover:scale-110">
//             {tool.icon}
//           </div>
//         </div>
//       ))}
